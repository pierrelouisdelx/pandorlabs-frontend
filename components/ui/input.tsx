...
import IconEyeOn from "@/components/icons/icon-eye-on"
      ...
      return (
          <div className="relative w-full">
              ...
              {!!iconLeft && (
                  <span
                      className={cn(
                          'absolute left-4 top-1/2 z-2 size-5 -translate-y-1/2 text-white',
                      )}
                  >
                      {iconLeft}
                  </span>
              ...
              {!!iconRight && (
                  <span
                      className={cn(
                          'absolute right-4 top-1/2 z-2 size-5 -translate-y-1/2 text-white',
                      )}
                  >
                      {iconRight}
                  </span>
              ...
              {type === 'password' && (
                  <button
                      tabIndex={-1}
                      type="button"
                      className="absolute right-4 top-1/2 z-2 size-5 -translate-y-1/2 inline-flex items-center justify-center text-white transition hover:opacity-80"
                      onClick={() =>
                          setFieldType(
