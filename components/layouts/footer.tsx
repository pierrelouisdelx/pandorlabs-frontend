            ...
            <div className="container">
                ...
                <div className="flex flex-col items-center gap-5 border-t border-white/30 py-7 sm:flex-row sm:justify-between">
                    <p className="order-2 text-center font-semibold sm:order-0 md:text-left">
                        © {new Date().getFullYear()}&nbsp;InfynixAI, Inc. All
                        rights reserved.
                    </p>
                    <div className="order-1 flex items-center gap-5 sm:order-0">
                        ...
                        >
                            ...
                            <IconFaceBook className="size-6 shrink-0 transition" />
                        </Link>
                        <Link
                        ...
                        >
                            ...
                            <IconTwitter className="size-6 shrink-0 transition" />
                        </Link>
                        <Link
                        ...
                        >
                            ...
                            <IconInstagram className="size-6 shrink-0 transition" />
                        </Link>
                        <Link
                        ...
                        >
                            ...
                            <IconLinkedin className="size-6 shrink-0 transition" />
                        </Link>
                    </div>
                </div>
            </div>
