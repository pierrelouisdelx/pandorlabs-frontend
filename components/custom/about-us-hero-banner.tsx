...
export default function AboutUsHeroBanner() {
    ...
    return (
        <div className="cursor-effect-section container flex flex-col items-center py-16 lg:pb-20 lg:pt-40">
            ...
            InfynixAI Transforming the Future of&nbsp;
                <AnimeTextEffect />
            </h1>
            <div className="relative text-center">
                ...
                >
                    <span className="absolute left-1/2 top-1/2 z-10 mt-1.5 -translate-x-1/2 -translate-y-1/2 text-white">
