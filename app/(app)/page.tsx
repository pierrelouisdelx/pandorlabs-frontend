                ...
                <div className="cursor-effect-section relative z-5 container pt-20">
                    <div className="mb-10 text-center">
                        ...
                        <p className="text-gray mx-auto max-w-xl text-lg">
                            Your go-to platform for Image Generator, Audio
                            Generator and Video Generator. We offer a wide range
                            of AI-powered tools to help you boost your online
                            solutions.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-5">
                        ...
                        <Dialog>
                            <DialogTrigger asChild>
                                ...
                                >
                                    <IconPlay className="play size-11 text-green-100" />
                                    Watch video
                                </button>
                            </DialogTrigger>
                    ...
                    <div className="grid gap-4 md:grid-cols-3 xl:gap-[30px]">
                        <div className="flex flex-col gap-4 xl:gap-[30px]">
                            <div className="border-gray/50 hover:bg-gray/0 border bg-linear-to-tr from-[#000000]/30 to-green-100/0 p-5 backdrop-blur-xs transition-all duration-500 hover:border-green-100/25 hover:from-green-100/30 hover:via-transparent hover:to-green-100/20">
                                ...
                                <div className="pb-3">
                                    InfynixAI&apos;s AI tools have streamlined
                                    our content creation process, boosting
                                    efficiency and creativity. The results are
                                    outstanding!
                                </div>
                            ...
                            <div className="border-gray/50 hover:bg-gray/0 border bg-linear-to-tr from-[#000000]/30 to-green-100/0 p-5 backdrop-blur-xs transition-all duration-500 hover:border-green-100/25 hover:from-green-100/30 hover:via-transparent hover:to-green-100/20">
                                ...
                                <div className="pb-3">
                                    Using InfynixAI’s image generation tools has
                                    transformed how we create visuals for our
                                    products. The quality and speed are
                                    unmatched!
                                </div>
                                <div className="border-gray/30 border-t pt-3">
                                    <h3 className="mb-0.5 text-lg/6 font-medium">
                            ...
                            <div className="border-gray/50 hover:bg-gray/0 border bg-linear-to-tr from-[#000000]/30 to-green-100/0 p-5 backdrop-blur-xs transition-all duration-500 hover:border-green-100/25 hover:from-green-100/30 hover:via-transparent hover:to-green-100/20">
                                ...
                                <div className="pb-3">
                                    Our team saves hours each week thanks to
                                    InfynixAI&apos;s AI-driven solutions. It has
                        ...
                        <div className="flex flex-col gap-4 xl:gap-[30px]">
                            <div className="border-gray/50 hover:bg-gray/0 border bg-linear-to-tr from-[#000000]/30 to-green-100/0 p-5 backdrop-blur-xs transition-all duration-500 hover:border-green-100/25 hover:from-green-100/30 hover:via-transparent hover:to-green-100/20">
                                ...
                                <div className="pb-3">
                                    The audio generation feature helped us
                                    produce engaging voiceovers for our social
                                    media campaigns in record time. It’s a
                                    must-have tool!
                                </div>
                                <div className="border-gray/30 border-t pt-3">
                                    <h3 className="mb-0.5 text-lg/6 font-medium">
                            ...
                            <div className="border-gray/50 hover:bg-gray/0 border bg-linear-to-tr from-[#000000]/30 to-green-100/0 p-5 backdrop-blur-xs transition-all duration-500 hover:border-green-100/25 hover:from-green-100/30 hover:via-transparent hover:to-green-100/20">
                                ...
                                <div className="pb-3">
                                    InfynixAI has helped improve the quality of
                                    our content. The AI tools are intuitive and
                                    have made content creation more effective.
                                </div>
                                <div className="border-gray/30 border-t pt-3">
                                    <h3 className="mb-0.5 text-lg/6 font-medium">
                                        David Nguyen
                        ...
                        <div className="flex flex-col gap-4 xl:gap-[30px]">
                            <div className="border-gray/50 hover:bg-gray/0 border bg-linear-to-tr from-[#000000]/30 to-green-100/0 p-5 backdrop-blur-xs transition-all duration-500 hover:border-green-100/25 hover:from-green-100/30 hover:via-transparent hover:to-green-100/20">
                                ...
                                <div className="pb-3">
                                    The video generation tool has allowed us to
                                    create professional videos without the need
                                    for extensive editing. Highly recommended!
                                </div>
                                <div className="border-gray/30 border-t pt-3">
                                    <h3 className="mb-0.5 text-lg/6 font-medium">
                                        Olivia Brown
                            ...
                            <div className="border-gray/50 hover:bg-gray/0 border bg-linear-to-tr from-[#000000]/30 to-green-100/0 p-5 backdrop-blur-xs transition-all duration-500 hover:border-green-100/25 hover:from-green-100/30 hover:via-transparent hover:to-green-100/20">
                                ...
                                <div className="pb-3">
                                    InfynixAI has provided us with creative
                                    freedom we didn’t know was possible. Their
                                    AI tools are powerful and easy to use.
                                </div>
                                <div className="border-gray/30 border-t pt-3">
                                    <h3 className="mb-0.5 text-lg/6 font-medium">
                                        James Thompson
                            ...
                            <div className="border-gray/50 hover:bg-gray/0 border bg-linear-to-tr from-[#000000]/30 to-green-100/0 p-5 backdrop-blur-xs transition-all duration-500 hover:border-green-100/25 hover:from-green-100/30 hover:via-transparent hover:to-green-100/20">
                                ...
                                <div className="pb-3">
                                    The AI-driven content optimization features
                                    have helped us boost our engagement rates.
                                    InfynixAI is a must for any marketer!
                                </div>
                                <div className="border-gray/30 border-t pt-3">
                                    <h3 className="mb-0.5 text-lg/6 font-medium">
                                        Sophia Davis
                    ...
                    >
                        <div className="space-y-4 xl:space-y-[30px]">
                            <AccordionItem value="item-1">
                                ...
                                <AccordionContent>
                                    AI-powered image generation allows you to
                                    create high-quality visuals using artificial
                                    intelligence, turning text descriptions into
                            ...
                            <AccordionItem value="item-2">
                                <AccordionTrigger>
                                    How does audio generation work in your
                                    platform?
                                </AccordionTrigger>
                                <AccordionContent>
                                    Our AI audio generation tool converts
                                    written text into realistic voiceovers or
                                    narrations in multiple languages and tones,
                            ...
                            <AccordionItem value="item-3">
                                ...
                                <AccordionContent>
                                    Our AI video generator helps you create
                                    professional-quality videos with minimal
                                    input. The tool automates editing, effects,
                                    and transitions to save you time while
                        ...
                        <div className="space-y-4 xl:space-y-[30px]">
                            <AccordionItem value="item-4">
                                ...
                                <AccordionContent>
                                    Yes, our platform allows full customization
                                    of images, audio, and video outputs to match
                                    your brand&apos;s voice and style, giving
                                    you more control over the results.
                                </AccordionContent>
                            </AccordionItem>
                            <AccordionItem value="item-5">
                                <AccordionTrigger>
                                    What kind of support do you provide with the
                                    plans?
                                </AccordionTrigger>
                                <AccordionContent>
                                    Our pricing plans come with varying levels
                                    of support: basic community support for the
                                    free plan, and priority or dedicated support
            ...
            <div className="container">
                ...
                <div className="flex items-center justify-center gap-5">
                    ...
                    <div className="group bg-gray/50 to-green-light relative flex items-center gap-0.5 overflow-hidden bg-linear-to-r from-green-100 p-0.5 hover:from-transparent hover:to-transparent">
                        ...
                        <Link
                            href="/about-us"
                            className="bg-primary z-5 px-2.5 py-2"
                        >
                            Learn more
                        </Link>
                    </div>
