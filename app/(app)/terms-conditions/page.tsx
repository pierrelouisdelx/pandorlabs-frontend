...
export const metadata: Metadata = {
    title: 'Terms & Conditions | InfynixAI',
    description:
    ...
    return (
        <>
            ...
            <div className="prose mx-auto w-full max-w-[1142px] px-4 pt-12 lg:prose-lg lg:pt-20">
                <p>
                    Welcome to InfynixAI! By using our services, you agree to
                    comply with and be bound by the following Terms &amp;
                    Conditions. Please read these terms carefully before using
                ...
                <ol type="1">
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                ...
                                purposes only and in compliance with all
                                applicable laws and regulations.
                            </li>
                            <li>
                                You agree not to engage in activities that may
                                disrupt or damage the functionality of our
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                Our services are offered at various pricing
                                tiers. By subscribing to any paid plan, you
                                agree to pay the specified fees in accordance
                                with the billing terms.
                            </li>
                            <li>
                                Payments are processed securely, and you are
                                responsible for ensuring that the billing
                    ...
                    <li>
                        ...
                        <p>
                            We make reasonable efforts to ensure our platform is
                            accessible 24/7. However, we do not guarantee
                            uninterrupted access, and we may perform maintenance
                    ...
                    <li>
                        ...
                        <p>
                        InfynixAI grants you a limited, non-exclusive,
                            non-transferable license to use our platform and
                            services for personal or business purposes in
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                Use our services for illegal or unauthorized
                                activities
                            </li>
                            <li>
                            ...
                            <li>
                                Use the platform to distribute harmful,
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                ...
                                your account and access to our services if you
                    ...
                    <li>
                        ...
                        <p>
                        InfynixAI’s liability to you is limited to the amount
                            paid for the specific service in question. We are
                    ...
                    <li>
                        ...
                        <p>
                            ...
                            and protect your personal data. Please review our
            ...
            <script
                ...
                "@type": "WebSite",
                "name": "Terms & Conditions | InfynixAI",
