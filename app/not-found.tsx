    ...
    return (
        <>
            <div className="relative flex min-h-screen bg-[url(/images/404.jpg)] bg-cover bg-center bg-no-repeat">
                <span className="absolute inset-0 bg-linear-to-l from-primary/90 via-primary/80 to-primary/90"></span>
                <div className="container relative z-10 m-auto py-20 text-center">
                    <div className="text-center">
                        <div>
                            ...
                            <span className="wave-animation mb-5 bg-linear-to-l from-green-100 to-green-light bg-clip-text text-[100px]/[150px] font-bold tracking-wider text-transparent lg:text-[250px]/[260px]">
                                404
                            </span>
                        </div>
                        ...
                        <div className="text-brown mx-auto mb-[30px] max-w-xl space-y-4 text-gray lg:text-lg/[26px]">
                            <p>
                                We couldn&apos;t find the page you&apos;re
                                looking for. It might have been moved, renamed,
                                or is temporarily unavailable. Let&apos;s help
